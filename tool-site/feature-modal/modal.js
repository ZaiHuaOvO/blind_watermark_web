...
var featureContent = {
  'blind-watermark': {
    ...
    html: [
      ...
      '  <p>🛡️ <strong>抗攻击</strong> — 支持裁剪、JPEG 压缩、缩放、旋转等常见攻击</p>',
  ...
  'nine-grid': {
    ...
    html: [
      ...
      '<hr class="feature-divider">',
      '<h3>这是什么？</h3>',
      '<p>基于 <strong>Cropper.js</strong> 原生 JavaScript 库实现的九宫格一键裁剪工具。将一张图片智能切分成九宫格拼图，并生成类似微信朋友圈、QQ 空间的拟真发布预览效果。</p>',
      ...
      '    <div class="mock-cell"></div>',
      '  </div>',
      '  <div class="mock-label">支持自定义调整九宫格间距</div>',
      '</div>',
      '<h3>✨ 特色功能</h3>',
      '<ul>',
      '  <li><strong>自由裁剪</strong> — 使用 Cropper.js 选取图片的任意区域</li>',
      '  <li><strong>智能切分</strong> — 一键将图片切成 3×3 九宫格</li>',
      '  <li><strong>拟真预览</strong> — 模拟微信朋友圈 / QQ 空间的发布效果</li>',
      '  <li><strong>间距调整</strong> — 自定义九宫格内部的间距大小</li>',
      '  <li><strong>纯前端</strong> — 所有处理在浏览器完成，不上传服务器</li>',
      '</ul>',
      '<hr class="feature-divider">',
  ...
  'about': {
    ...
    html: [
      ...
      '<hr class="feature-divider">',
      '<h3>这是什么？</h3>',
      '<p>一个由<a href="https://github.com/ZaiHuaOvO" target="_blank" style="color:#b080a0;font-weight:500;">再花</a>开发的各种便利实用性工具合集，通常为自己或朋友需要的。</p>',
      '<h3>为什么有密钥？</h3>',
      '<p>再花的服务器资源性能极其有限，所以为所有需要占用服务器资源的工具都设置了密钥。</p>',
      '<h3>想要获得更多？</h3>',
      '<p>想要新的工具 / 某个工具有新的需求 / 想要为某个开源项目适配 Web 端 / 工具有 BUG，给我写邮件。</p>',
